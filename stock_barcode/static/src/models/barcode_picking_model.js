...
export default class BarcodePickingModel extends BarcodeModel {
    ...
    _convertDataToFieldsParams(args) {
        const params = {
            ...
            qty_done: args.qty,
            ex_date: args.expiration_date,
        };
        if (args.lot) {
            params.lot_id = args.lot;
            params.ex_date = args.ex_date;
        }
        if (args.package) {
    ...
    _createCommandVals(line) {
        console.log("lllllllllllllllllllll",line);
        const values = {
    ...
    _createLinesState() {
        ...
        for (const id of picking.move_line_ids) {
            ...
            smlData.ex_date = smlData.ex_date;
